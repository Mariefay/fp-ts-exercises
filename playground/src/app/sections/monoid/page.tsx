      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Semigroup + identity element - handle empty cases elegantly
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li>• concat + empty operations</li>
                <li>• Working with empty arrays</li>
                <li>• struct for complex types</li>
                <li>• Creating custom monoids</li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">
              ...
              <ul className="space-y-2 text-gray-600">
                <li>• Aggregating metrics safely</li>
                <li>• Combining feature flags</li>
                <li>• Flattening nested arrays</li>
                <li>• Safe data aggregation</li>
              </ul>
            </div>
          </div>
        </div>
