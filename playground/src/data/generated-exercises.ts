...
// Generated on: 2026-02-07T19:19:18.502Z
...
export const generatedExercises: Exercise[] = [
  ...
  },
  {
    ...
    "testCode": "describe('ReaderTaskEither mapLeft', () => {\n  const config: Config = {}\n\n  it('transforms error value', async () => {\n    const result = await convertErrorToMessage()(config)()\n    expect(E.isLeft(result)).toBe(true)\n    if (E.isLeft(result)) {\n      expect(result.left).toBe('Error 404: Not Found')\n    }\n  })\n})"
  },
  {
    "id": "readertaskeither-07",
    "title": "Parallel",
    "description": "Learn about parallel in fp-ts readertaskeither",
    "category": "Readertaskeither",
    "fileName": "07-parallel.exercise.ts",
    "difficulty": "advanced",
    "order": 7,
