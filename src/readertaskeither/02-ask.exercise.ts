...
// @ts-ignore
const getDbConnection = (): RTE.ReaderTaskEither<Env, string, string> => {
  //TODO: Read dbUrl from environment and return connection string
  //HINT: Use RTE.asks to extract a specific field
}

// @ts-ignore
const getTimeout = (): RTE.ReaderTaskEither<Env, string, number> => {
  //TODO: Read timeout from environment
  //HINT: Use RTE.asks
}
